...
namespace Barryvdh\Debugbar {
     ...
     */
    class Facade extends \DebugBar\DebugBar {
        /**
...
namespace Spatie\Newsletter\Support {
    /**
     */
    class Lists extends \Illuminate\Support\Collection {
            }
    }
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {        /**
         ...
         * @static
         */
        public static function whereVectorSimilarTo($column, $vector, $minSimilarity = 0.59999999999999997779553950749686919152736663818359375, $order = true)
        {
            /** @var \Illuminate\Database\Query\Builder $instance */
    ...
    class Active extends \App\Helpers\Active {}
