...
@section('title', 'Add Test | ' . env('APP_NAME'))
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header d-flex justify-content-between align-items-center py-2">
                <h6 class="mb-0">Add New Test</h6>
                <a href="{{route('admin.testseries.testlist',$id)}}" class="btn btn-secondary btn-sm">
 ...
 <div class="col-md-2">
                            <label class="form-label fw-semibold">Is Previuos Year Test?</label>
                    ...
                    <div class="col-12 text-end mt-2">
                        <button type="submit" class="btn btn-success">
                            <i class="bx bx-save"></i> Save Test
                        </button>
                    </div>
                </form>
            </div>
