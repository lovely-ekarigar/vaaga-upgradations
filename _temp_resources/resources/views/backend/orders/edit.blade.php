...
@section('title', 'Edit Order | '.app_name())

@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline mb-0">Edit Order</h3>
                        ...
                        <div class="form-group">
                            ...
                            <select name="course_ids[]" id="course_ids" class="form-control" multiple required>
                                @foreach($courses as $course)
                                    <option value="{{ $course->id }}" {{ in_array($course->id, old('course_ids', $selectedCourseIds)) ? 'selected' : '' }}>
                                        {{ $course->title }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="amount" id="amount" class="form-control" value="{{ old('amount', $order->amount) }}" required>
                            @error('amount')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="discount" id="discount" class="form-control" value="{{ old('discount', $order->discount ?? 0) }}">
                            @error('discount')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="gst" id="gst" class="form-control" value="{{ old('gst', $order->gst ?? 0) }}">
                            @error('gst')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="payment_type" id="payment_type" class="form-control" required>
                                <option value="0" {{ old('payment_type', $order->payment_type) == '0' ? 'selected' : '' }}>In Progress</option>
                                <option value="1" {{ old('payment_type', $order->payment_type) == '1' ? 'selected' : '' }}>Stripe/Card</option>
                                <option value="2" {{ old('payment_type', $order->payment_type) == '2' ? 'selected' : '' }}>PayPal</option>
                                <option value="3" {{ old('payment_type', $order->payment_type) == '3' ? 'selected' : '' }}>Offline</option>
                                <option value="4" {{ old('payment_type', $order->payment_type) == '4' ? 'selected' : '' }}>Razorpay</option>
                            </select>
                            @error('payment_type')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control" required>
                                ...
                                <option value="1" {{ old('status', $order->status) == '1' ? 'selected' : '' }}>Completed</option>
                            </select>
                            @error('status')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="end_date" id="end_date" class="form-control" value="{{ old('end_date', $order->end_date ? date('Y-m-d', strtotime($order->end_date)) : '') }}">
                            @error('end_date')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="total_cycle" id="total_cycle" class="form-control" value="{{ old('total_cycle', $order->total_cycle) }}" min="0">
                            @error('total_cycle')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="paid_cycle" id="paid_cycle" class="form-control" value="{{ old('paid_cycle', $order->paid_cycle ?? 0) }}" min="0">
                            @error('paid_cycle')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
