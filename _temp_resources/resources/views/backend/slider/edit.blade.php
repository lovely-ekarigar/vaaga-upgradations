    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row form-group">
             ...
             @php
                $slider_data = json_decode($slide->content);
                ...
                <div class="col-md-10">
                    <!-- {{ html()->text('hero_text')
                        ...
                        ->placeholder(__('labels.backend.hero_slider.fields.hero_text'))
                         ...
                         <input type="text" class="form-control" value="{{$slider_data->hero_text}}" name="hero_text">
                </div>
            </div>
            <div class="row form-group">
                ...
                <div class="col-md-10">
                    <!-- {{ html()->text('sub_text')
                        ...
                        ->placeholder(__('labels.backend.hero_slider.fields.sub_text'))
                         ...
                         <input type="text" class="form-control" value="{{$slider_data->sub_text}}" name="sub_text">
                </div><!--col-->
            </div>
            <!-- <div class="row form-group">
