        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12 form-group">
                 ...
                 <div class="col-12 form-group">
                      <label for="videoLink" class="control-label">Video Link(embed)*</label>
                        <textarea type="text" class="form-control" name="video_link" id="videoLink" placeholder="Enter Video Link"></textarea>
