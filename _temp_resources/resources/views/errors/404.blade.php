...
<title>{{env('PROJECT_NAME')}}TLE 404</title>
...
<a href="{{url('/')}}">
<img src="{{asset('newassets/img/logo.png')}}" class="img-fluid" alt="Logo">
</a>
</div>
<div class="error-box-img">
<img src="/frontend/assets/img/error-01.png" alt="" class="img-fluid">
</div>
