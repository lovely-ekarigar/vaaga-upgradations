...
class BlogController extends Controller
{
    ...
    public function cat(Request $request){
        ...
        if($request->del){
          $bc =  BlogCategory::find($request->del);
          if($bc){
              $bc->delete();
          }
          return redirect()->route('admin.blogs-cat.index')->withFlashDanger("Category deleted");
        }
    ...
    public function addCat(){
       ...
       return view('backend.blogs.add-category'); 
    }
    
    public function editCat($id){
        $cat = BlogCategory::find($id);
         return view('backend.blogs.edit-category',compact('cat'));  
    }
    ...
    public function updateCat($id,Request $request){
        ...
        $cat->update();
           return redirect()->route('admin.blogs-cat.index')->withFlashSuccess("Category updated");
    }
    ...
    public function saveCat(Request $request){
        ...
        $cat->slug = Str::slug($request->name);
        $cat->save();
           return redirect()->route('admin.blogs-cat.index')->withFlashSuccess("Category added");
    }
 ...
 $blogs = $blogs->get();
    ...
    public function create()
    {
        ...
        $category = BlogCategory::pluck('name','id')->prepend('Please select', '');
