...
class User extends Authenticatable implements MessageableInterface
{
    ...
    public function purchasedCourses()
    {
        ...
        //     ->pluck('item_id');
        //     $list=DB::table("course_student")->where("user_id",$this->id)->pluck('course_id');
        ...
        foreach ($orders as $order) {
            ...
            $clist = OrderItem::where("order_id", $order->id)->where('item_type', '=', "App\Models\Course")->get();
    ...
    //     $demo_request_list = DemoRequest::where('user_id','=',$this->id)->pluck('course_id');
    //     $demo_courses = Course::where('id',$demo_request_list)->get();
