        ...
        <div class="card shadow-sm border-0">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 text-black">Sections for {{$course->name}}</h5>
                   ...
                   <table id="subjects" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-primary" href="{{route('admin.testseries.chapters',[$subject->id])}}">Chapters</a>
...
<div class="modal fade" id="addSubjectModal" tabindex="-1">
  <div class="modal-dialog">
    <form action="{{ route('admin.subjects.store',[$course->id]) }}" method="POST">
        @csrf
