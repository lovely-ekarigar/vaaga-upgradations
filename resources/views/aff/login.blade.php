        ...
        <div class="card-content">
          ...
          <div class="card-body">
            ...
            <form class="form-horizontal" method="post" novalidate>
              ...
              <button type="submit" class="btn btn-outline-info btn-block"><i class="la la-user"></i> Login</button>
            </form>
          </div>
          <div class="card-body">
            <a href="/affiliate/register" class="btn btn-outline-danger btn-block"><i class="ft-unlock"></i>
              Register</a>
          </div>
        </div>
      </div>
