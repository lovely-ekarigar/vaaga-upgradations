        ...
        $(document).ready(function () {
            ...
            var myTable = $('#myTable').DataTable({
                ...
                columns: [
                    ...
                    {data: "confirmed_label", name: "confirmed_label", "orderable": false,},
                    {data: "roles_label", name: "roles.name", "orderable": false,},
                    {data: "permissions_label", name: "permissions.name", "orderable": false,},
                    {data: "social_buttons", name: "social_accounts.provider", "searchable": false, "orderable": false,},
