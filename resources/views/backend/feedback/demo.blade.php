...
@section('title', __('Demo Feedback').' | '.app_name())
...
<style type="text/css">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <h3 class="page-title d-inline">{{$demo->name}}  Feedbacks</h3>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 col-12">
                            <a href="/user/demo-feedback-list/{{$id}}?type={{$userType}}&qid={{$q->id}}" style="text-decoration: none;">
