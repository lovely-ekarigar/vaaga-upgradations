...
@section('title','Assignment Uploads'.' | '.app_name())
  ...
  form{
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left mb-0">{{$batch->name}} Uploaded Assignment</h3>
...
<span class="badge badge-danger">Not Uploaded</span>
                        ...
                        <td>
                            @if($user->uploaded)
                                @if($user->assignment->remarks)

                                {{$user->assignment->remarks}}
                                ...
                                <form method="post">
                                    ...
                                    <input type="text" name="remarks" class="form-control mb-2" placeholder="Enter Remarks">
