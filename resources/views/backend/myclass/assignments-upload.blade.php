        ...
        <div class="col-lg-8 col-xl-9">
          <div class="profile-content-area my-6 card card-body">
            <div class=" mb-6 pb-6">
              ...
              <h6 class="text-body fw-500 mb-3">Assignments for {{$batch->name}} </h6>
              <h6 class="text-body fw-500 mb-3">Assignment:    {{$assig->title}} </h6>
                <div class="row">
                	...
                	<form  method="post" enctype="multipart/form-data">
                		...
                		<input type="submit" name="submit" value="Upload Assignment" class="btn btn-sm btn-primary">


                	</form>
                	@else

                	<h5>Your assigment has been uploaded at {{date('d M Y',strtotime($upload->created_at))}}</h5>
