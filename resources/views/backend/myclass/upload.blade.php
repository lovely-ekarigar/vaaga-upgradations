  ...
  form{
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left mb-0">{{$batch->name}} Upload file(s)</h3>
...
<hr>
   ...
   <tr data-entry-id="1" role="row" class="odd">
      ...
      <td>
         ...
         <a href="/{{$l->file_url}}" download class="btn btn-xs btn-primary mb-1"><i class="fa fa-download" aria-hidden="true"></i>
</a>
<?php 
