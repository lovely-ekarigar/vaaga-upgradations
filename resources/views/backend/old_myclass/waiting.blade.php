...
<body>
  ...
  <script>
      ...
      var parent_api_class_id = "{{$id}}";
      var batch_id ="{{$batch->id}}";
      
      function checkWaiting(){
          $.ajax({
              url:'/user/check-waiting/'+parent_api_class_id,
              type:'GET',
              ...
              error:function(){
                  alert("Something went wrong. Kindly contact with support.")
              }
          })
      }
      checkWaiting();
