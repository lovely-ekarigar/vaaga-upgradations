...
<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/timepicker/1.3.5/jquery.timepicker.min.css">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left mb-0">{{$user->name}} availability</h3>

           <div class="float-right">
                    <a href="{{ route('admin.teachers_availability',['id'=>$user->id]) }}"
                       class="btn btn-primary btn-sm">View Calendar</a>
