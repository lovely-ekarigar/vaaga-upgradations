...
<head>
    ...
    <title>VaaGa Academy : Certificate of Completion</title>
...
<div class="container-fluid px-0" style="height: 500px"> 
    <div style="position: relative;text-align: center"
        ...
        <div class="col-12 text-block align-self-center">
            ...
            <p  style="word-wrap: break-word;white-space: nowrap">on <span class="font-weight-bold" style="font-family: DejaVu Sans;">VaaGa Academy</span> online course on <span class="font-weight-bold">{{$data['date']}}</span></p>
        </div>
